...
import 'package:librarywalk/app/data/constans/endpoint.dart';
import 'package:librarywalk/app/data/models/response_bookPopular.dart';
// import 'package:librarywalk/app/data/models/response_koleksi.dart';
import 'package:librarywalk/app/data/provider/api_provider.dart';
...
class HomeController extends GetxController with StateMixin<MyState<List<DataBookNew>, List<DataBookPopular>>>{
    ...
    try {
        ...
        if (responseBukuNew.statusCode == 200) {
          ...
          if(responseBookNew.data!.isEmpty) {
            ...
            final newData = MyState(state1: responseBookNew.data, state2: responseBookPopular.data);
